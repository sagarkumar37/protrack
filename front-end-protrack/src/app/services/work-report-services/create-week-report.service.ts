...
export class CreateWeekReportService {
  ...
  private apiUrl = `${environment.API_BASE_URL}/createWeeklyTaskReport`
   createWeekReport(inputs:any[],year_week:number):Observable<HttpResponse<string>>{
